...
<body>
    ...
    <main class="dashboard">
        <section class="strip">
            <h2>Mis pagos</h2>
            <p><strong>Agosto 2025:</strong> Pagado</p>
            <p><strong>Julio 2025:</strong> Pagado</p>
            <p><strong>Junio 2025:</strong> Pendiente</p>
        </section>
        ...
        <section class="strip alt">
            ...
            <form>
                <label for="comprobante" class="btn-hover2">Subir comprobante</label>
